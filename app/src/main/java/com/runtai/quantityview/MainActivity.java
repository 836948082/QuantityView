package com.runtai.quantityview;
...
import com.runtai.quantityviewlibrary.QuantityView;
...
public class MainActivity extends AppCompatActivity implements QuantityView.OnQuantityChangeListener {
    ...
    private QuantityView quantityViewDefault;
    private QuantityView quantityViewCustom1;
    private QuantityView quantityViewCustom2;
    ...
    private void initView() {
        quantityViewDefault = (QuantityView) findViewById(R.id.quantityView_default);
        quantityViewDefault.setOnQuantityChangeListener(this);
        quantityViewCustom1 = (QuantityView) findViewById(R.id.quantityView_custom_1);
        quantityViewCustom1.setOnQuantityChangeListener(this);
        quantityViewCustom2 = (QuantityView) findViewById(R.id.quantityView_custom_2);
    ...
    public void onQuantityChanged(int newQuantity, boolean programmatically) {
        ...
        Log.e("更新后的值" + newQuantity, "programmatically" + programmatically);
    }

    @Override
    public void onLimitReached() {
        Log.e("超出范围", "Limit reached");
    }
